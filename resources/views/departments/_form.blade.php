...
<div>
    <label class="block text-sm font-medium mb-1">اسم القسم *</label>
    <input type="text" name="name" required value="{{ $val('name') }}" class="w-full border rounded px-3 py-2">
</div>
<div>
    <label class="block text-sm font-medium mb-1">القسم الرئيسي</label>
...
<div>
    <label class="block text-sm font-medium mb-1">مدير القسم</label>
